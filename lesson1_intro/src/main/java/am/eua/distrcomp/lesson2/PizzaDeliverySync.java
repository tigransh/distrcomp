...
/**
 * A class for simulating synchronous communication
 */
public class PizzaDeliverySync {
    /**
     * Takes the pizza order and initiates processing
     * @param customer customer name
     */
    public void orderPizza(String customer) {
        System.out.println("Pizza ordered for " + customer + ".");
    ...
    public static void main(String[] args){
        ...
        PizzaDeliverySync delivery = new PizzaDeliverySync();
